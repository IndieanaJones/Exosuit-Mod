...
public class ContainerMessagerChickenInventory extends ContainerExosuitInventory 
{
    public ContainerMessagerChickenInventory(EntityPlayer player, AbstractExosuit mob) 
    {
        ...
        this.addSlotToContainer(new RestrictedExosuitSlot(exosuit.inventory, 1, 98, 18, Arrays.asList(ItemInit.EXOSUIT_CHICKEN_DOUBLE_JUMP_MK1, ItemInit.EXOSUIT_CHICKEN_ARMOR_MK1), 1));
        this.addSlotToContainer(new RestrictedExosuitSlot(exosuit.inventory, 2, 116, 18, Arrays.asList(ItemInit.EXOSUIT_CHICKEN_SPEED_MK1), 1));
    }
}